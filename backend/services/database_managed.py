"""
Managed Database service for Smart Tracker
Uses external managed PostgreSQL database
"""
...
def init_db():
    ...
    try:
        ...
        database_url = settings.database_url or "postgresql+psycopg2://root:cXf2dtQlN8m6*{tef,]B@151.115.13.23:12061/rdb"
        ...
        logger.info("Managed database initialized")
